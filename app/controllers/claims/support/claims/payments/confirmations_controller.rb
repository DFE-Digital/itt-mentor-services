class Claims::Support::Claims::Payments::ConfirmationsController < Claims::Support::ApplicationController
  before_action :authorize_confirmation

  def create
    Claims::Payment::ParseConfirmation.call(file: file_param)

    redirect_to claims_support_claims_payments_path, flash: { heading: t(".success"), success: true }
  end
