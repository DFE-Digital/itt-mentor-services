class Placements::Support::Schools::Placements::AddPlacementController < Placements::ApplicationController
  ...
  def update
    if !@wizard.save_step
      ...
      @wizard.reset_state
      redirect_to placements_support_school_placements_path(@school), flash: { success: t(".success") }
    end
  end
