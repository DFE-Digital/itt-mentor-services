...
RSpec.describe "Support user does not enter the first name", service: :placements, type: :system do
  scenario do
    ...
    when_i_enter_the_users_last_name_and_email_address
    and_i_click_on_continue
    then_i_see_an_error_related_to_the_users_first_name
  end
  ...
  def when_i_enter_the_users_last_name_and_email_address
  ...
  def then_i_see_an_error_related_to_the_users_first_name
