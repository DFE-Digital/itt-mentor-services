...
RSpec.describe "Support user adds a provider", :js, service: :placements, type: :system do
  scenario do
    ...
    when_i_type_banana
    and_i_select_university_of_banana
    and_i_click_continue
    ...
    # Valid input
    when_i_type_apple
    and_i_select_pineapple_university
    and_i_click_continue
  ...
  def and_i_select_pineapple_university
    page.find(".autocomplete__option", text: "Pineapple University (SW4 9QZ)", wait: 10).click
  end

  def and_i_select_apple_academy
    page.find(".autocomplete__option", text: "Apple Academy (BS1 5AY)", wait: 10).click
  end
  ...
  def and_i_select_university_of_banana
    page.find(".autocomplete__option", text: "University of Banana", wait: 10).click
  end
