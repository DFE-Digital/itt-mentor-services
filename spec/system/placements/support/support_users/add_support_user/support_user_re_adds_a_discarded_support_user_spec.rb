...
RSpec.describe "Support user re-adds a discarded support user",
  ...
  scenario do
    ...
    when_i_enter_the_details_of_the_discarded_support_user
  ...
  def when_i_enter_the_details_of_the_discarded_support_user
