...
RSpec.describe "Support user deletes an onboarded partner provider",
               service: :placements,
               type: :system do
  ...
  scenario do
    ...
    and_i_see_the_niot_provider
    and_a_notification_email_is_sent_to_best_practice_network
  end
  ...
  def and_a_notification_email_is_sent_to_best_practice_network
