...
RSpec.describe "Primary school user adds a placement", service: :placements, skip: "Temporary", type: :system do
  scenario do
    ...
    when_i_continue_from_the_year_group_page_to_the_check_your_answers_page
  ...
  alias_method :when_i_continue_from_the_year_group_page_to_the_check_your_answers_page, :and_i_continue_from_the_year_group_page_to_the_check_your_answers_page
  ...
  def and_i_see_my_placement
    expect(page).to have_element(:td, text: "Primary (Year 2)", class: "govuk-table__cell")
