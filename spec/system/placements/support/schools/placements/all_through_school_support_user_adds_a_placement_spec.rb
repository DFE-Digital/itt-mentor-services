...
RSpec.describe "All-through support school user adds a placement", service: :placements, type: :system do
  scenario do
    given_that_placements_data_exists
    and_i_am_signed_in

    when_i_am_on_the_organisations_index_page
    and_i_select_malory_towers
  ...
  def given_that_placements_data_exists
    @school = create(:placements_school, name: "Malory Towers",
  ...
  def and_i_select_malory_towers
    click_on "Malory Towers"
  end

  def then_i_see_the_placements_index_page
    expect(page).to have_title("Placements - Manage school placements - GOV.UK")
    expect(page).to have_element(:span, text: "Malory Towers", class: "govuk-heading-s govuk-heading-s govuk-!-margin-bottom-0")
