...
RSpec.describe "View organisations", service: :placements, type: :system do
  let(:one_school) { create(:placements_school, with_hosting_interest: true, name: "One School") }
  let(:one_provider) { create(:placements_provider, name: "One Provider") }
  let(:multi_org_school) { create(:placements_school, with_hosting_interest: true, name: "Placements School") }
