...
RSpec.describe "Non-support user uses a school deep link", service: :placements, type: :system do
  scenario do
    given_my_school_exists
  ...
  def given_my_school_exists
    @school = create(:placements_school, name: "Hogwarts")
  end

  def and_i_have_an_account
    sign_in_placements_user(organisations: [@school], sign_in: false)
  end
