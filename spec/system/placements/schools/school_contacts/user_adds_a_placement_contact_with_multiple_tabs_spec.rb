...
RSpec.describe "School user adds a placement contact to their school using multiple tabs", :js, service: :placements, type: :system do
  scenario do
    given_i_am_signed_in
    and_i_have_two_browser_tabs_open
  ...
  def and_i_have_two_browser_tabs_open
