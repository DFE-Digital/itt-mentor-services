...
RSpec.describe "School user updates their school's message to provider",
               service: :placements,
               type: :system do
  scenario do
    ...
    when_i_click_on_change_message_to_provider
  ...
  def when_i_click_on_change_message_to_provider
    click_on "Change Message to provider"
  end
