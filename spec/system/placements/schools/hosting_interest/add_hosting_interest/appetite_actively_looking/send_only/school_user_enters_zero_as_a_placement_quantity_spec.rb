...
RSpec.describe "School user enters zero as a placement quantity",
  ...
  scenario do
    ...
    when_i_fill_in_the_number_of_send_placements_with_zero
    and_i_click_on_continue
  ...
  def when_i_fill_in_the_number_of_send_placements_with_zero
    fill_in "How many SEND placements can you offer?", with: 0
  end
