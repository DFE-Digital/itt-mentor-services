...
RSpec.describe "School user enters a float as a placement quantity",
  ...
  scenario do
    ...
    when_i_fill_in_the_number_of_send_placements_with_a_float
    and_i_click_on_continue
  ...
  def when_i_fill_in_the_number_of_send_placements_with_a_float
    fill_in "How many SEND placements can you offer?", with: 2.5
  end
