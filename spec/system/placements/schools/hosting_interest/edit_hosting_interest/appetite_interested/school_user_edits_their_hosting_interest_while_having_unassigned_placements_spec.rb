...
RSpec.describe "School user edits their hosting interest while having unassigned placements",
               service: :placements,
               type: :system do
  scenario do
    ...
    then_i_see_the_change_placement_availability_page
    and_the_schools_placements_for_the_selected_academic_year_are_listed
  ...
  def and_placements_exist
    @year_1_placement = create(
      :placement,
      school: @school,
      academic_year: @next_academic_year,
      subject: @primary,
  ...
  def then_i_see_the_change_placement_availability_page
    expect(page).to have_title(
      "Are you sure you want to change your placement availability? - Placement details - Manage school placements - GOV.UK",
    )
    expect(primary_navigation).to have_current_item("Organisation details")
    expect(page).to have_span_caption("Placement details")
    expect(page).to have_h1("Are you sure you want to change your placement availability?")
    expect(page).to have_paragraph(
      "Changing your placement availability will mean your existing placements will be deleted.",
    )
  end

  def and_the_schools_placements_for_the_selected_academic_year_are_listed
