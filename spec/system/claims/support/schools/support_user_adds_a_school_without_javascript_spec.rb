...
RSpec.describe "Support user adds a school without javascript", service: :claims, type: :system do
  ...
  def then_i_see_search_results_for_st_champions
    expect(page).to have_title("1 results found for ‘st champions’ - Add organisation - Claim funding for mentor training - GOV.UK")
    expect(page).to have_span_caption("Add organisation")
  ...
  def then_i_see_no_results_found
    expect(page).to have_title("0 results found for ‘Hogwarts’ - Add organisation - Claim funding for mentor training - GOV.UK")
  ...
  def then_i_see_search_results_for_sherborne
    expect(page).to have_title("1 results found for ‘sherborne’ - Add organisation - Claim funding for mentor training - GOV.UK")
    expect(page).to have_span_caption("Add organisation")
  ...
  def then_i_see_search_results_for_guildford
    expect(page).to have_title("1 results found for ‘guildford’ - Add organisation - Claim funding for mentor training - GOV.UK")
    expect(page).to have_span_caption("Add organisation")
