...
RSpec.describe "Support user uploads a CSV containing invalid an unpaid reason",
               service: :claims,
               type: :system do
  scenario do
    given_claims_exist
    ...
    when_i_upload_a_file_missing_an_unpaid_reason_for_the_unpaid_claim
  ...
  def and_i_see_the_csv_contained_claims_not_with_the_status_payment_in_progress
    ...
    expect(page).to have_element(:td, text: "Enter a reason", class: "govuk-table__cell", count: 1)
