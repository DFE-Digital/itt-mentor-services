...
RSpec.describe "Support user uploads a CSV containing a mentor not associated with the claims",
               service: :claims,
               type: :system do
  scenario do
    given_claims_exist
    ...
    when_i_upload_a_csv_containing_a_mentor_not_associated_with_the_claims
