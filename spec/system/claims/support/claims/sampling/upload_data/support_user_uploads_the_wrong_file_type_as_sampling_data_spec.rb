...
RSpec.describe "Support user uploads the wrong file type as sampling data", service: :claims, type: :system do
  scenario do
    given_claims_exist
    and_i_am_signed_in
    ...
    then_i_see_validation_error_regarding_the_incorrect_file_type
  end
