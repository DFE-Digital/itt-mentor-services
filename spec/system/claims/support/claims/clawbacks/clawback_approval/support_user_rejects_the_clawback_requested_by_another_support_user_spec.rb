...
RSpec.describe "Support user rejects the clawback requested by another support user",
               service: :claims,
               type: :system do
  ...
  scenario do
    ...
    then_i_see_a_validation_error_for_not_entering_a_reason_for_rejecting_the_clawback

    when_i_enter_a_reason_for_rejection
    and_click_on_continue
  ...
  def then_i_see_a_validation_error_for_not_entering_a_reason_for_rejecting_the_clawback
    expect(page).to have_validation_error("Please enter a reason why you are rejecting this clawback")
  end

  def when_i_enter_a_reason_for_rejection
    fill_in "If No, please provide a reason", with: "Reason for clawback rejection"
  end
  ...
  def and_i_see_the_clawback_requested_tag
    expect(page).to have_tag("Clawback rejected", "red")
  end

  def and_i_see_a_success_banner
    expect(page).to have_success_banner(
      "Clawback rejected",
      "Please inform Harry Potter that this clawback has been rejected.",
    )
  end
end
