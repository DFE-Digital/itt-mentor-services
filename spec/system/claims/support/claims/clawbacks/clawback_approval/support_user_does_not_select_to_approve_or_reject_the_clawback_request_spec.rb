...
RSpec.describe "Support user does not select to approve or reject the clawback request",
  service: :claims,
 type: :system do
  ...
  scenario do
    ...
    then_i_see_a_validation_error_for_not_selecting_an_option
  end
  ...
  def then_i_see_a_validation_error_for_not_selecting_an_option
    expect(page).to have_validation_error(
      "Please select whether or not this clawback information is correct",
    )
  end
end
