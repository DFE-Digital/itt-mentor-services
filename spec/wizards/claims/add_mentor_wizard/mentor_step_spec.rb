...
RSpec.describe Claims::AddMentorWizard::MentorStep, type: :model do
  ...
  let(:mock_wizard) do
    instance_double(Claims::AddMentorWizard).tap do |mock_wizard|
  ...
  describe "#mentor" do
    it "returns an instance of a Claims::Mentor" do
