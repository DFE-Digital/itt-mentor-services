...
RSpec.describe Claims::UploadProviderResponseWizard::UploadErrorsStep, type: :model do
  ...
  let(:missing_rejection_reason_claim_references) { nil }
  ...
  describe "#missing_assured_reason_claims" do
    ...
    context "when the upload step missing_rejection_reason_claim_references attribute contains a reference" do
