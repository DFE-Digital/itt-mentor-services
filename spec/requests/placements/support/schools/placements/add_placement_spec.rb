...
RSpec.describe "Support console / 'Add placement' journey", service: :placements, type: :request do
  ...
  context "when the wizard is complete" do
    ...
    it "redirects to the school's list of placements" do
      put step_path(:check_your_answers)
      expect(response).to redirect_to placements_support_school_placements_path(school_id:)
    end
  end
