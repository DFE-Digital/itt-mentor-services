...
RSpec.describe Placements::SchoolUserMailer, type: :mailer do
  ...
  describe "#placement_information_added_notification" do
    ...
    let(:hosting_interest) { create(:hosting_interest, academic_year:, appetite: appetite) }
    let(:school) { create(:placements_school, name: "School 1", hosting_interests: [hosting_interest]) }
    ...
    context "when appetite is interested" do
      ...
      it "sends a notification email to the user of the school" do
        ...
        expect(placement_information_added_notification.body).to have_content <<~EMAIL
          ...
          Providers will be able to email [#{school.school_contact_email_address}](mailto:#{school.school_contact_email_address}) about your placements your school may be able to offer.
