  ...
  describe "#call" do
    it "generates a CSV file of claims" do
      ...
      expect(csv.headers).to eq(
        %w[claim_reference school_urn school_name school_local_authority claim_amount school_type_of_establishment school_group claim_submission_date claim_status claim_unpaid_reason provider_name],
      )
